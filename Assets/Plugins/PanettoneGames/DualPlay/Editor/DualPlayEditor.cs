...
namespace DualPlay.Editor
{
    ...
    public class DualPlayEditor : UnityEditor.EditorWindow
    {
        ...
        private const int windowMinHeight = 100;
        ...
        private void InitialiseSettings()
        {
            ...
            linkLibrary = dualPlaySettingsAsset.linkLibrary;
        ...
        private void SaveSettings()
        {
            ...
            dualPlaySettingsAsset.linkLibrary = linkLibrary;
        }
